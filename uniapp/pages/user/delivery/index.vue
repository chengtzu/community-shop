			...
			<view class="order-list">
				<view class="item" v-for="(item, index) in listData" :key="index">
					...
					<view class="one-product d-s-c" >
						...
						<view class="pro-info flex-1">
							<view>张三 （<text>15548906781</text>）</view>
							<view><text class="icon iconfont icon-dizhi1"></text>金域华城 29#01-602</view>
						</view>
						<view class="total-count">
							<!-- <view class="left-shadow"></view>
							<view class="price f22">
					...
					<view class="order-bts">
						<block v-if="item.order_status.value != 20">
							...
							<!-- 订单付款 -->
							<block>
								<button class="btn-red" @click="bohao('15548906781')">拨号</button>
							</block>
							<!-- 确认收货 -->
